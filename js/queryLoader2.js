...
! function e(t, n, i) {
    ...
    4: [function(e, t, n) {
        ...
        var i = e("./PercentageParser"),
            r = {
                create: function() {
                    this.element = document.getElementById('preloader-precent'), this.updateProgress(0, 0)
                },
                setStyling: function() {
                    this.element.style.height = this.barHeight + "px", this.element.style.marginTop = "-" + this.barHeight / 2 + "px", this.setTransitionTime(100),
                        this.element.style.marginLeft = 'auto', this.element.style.marginRight = 'auto'
                },
                updateProgress: function(e, t) {
                    0 !== t && this.setTransitionTime(t), e = i(e), this.element.style.width = e + "%",
                    document.getElementById('preloader-num').innerText=e+'%'
                },
        ...
        t.exports = function() {
            ...
            return e.element = null, e.className = "c-preloader__percent-line", e.barHeight = 1, e.barColor = "#fff", e
        }
    }, {
        "./PercentageParser": 6
    }],
    ...
    7: [function(e, t, n) {
        ...
        t.exports = function(e) {
            ...
            return t.parentElement = e, t.idName = "preloader", t.percentageId = "qlPercentage", t.className = "c-preloader", t.element = null, t.loadingBar = null, t.percentage = null, t.barColor = "#ff0000", t.barHeight = 1, t.fadeOutTime = 300, t.showPercentage = !1, t
        }
    }, {
        "./LoadingBar": 4,
        "./Percentage": 5
        ...
        t.exports = function() {
            var e = window.setInterval(function() {
                if ("undefined" != typeof document.getElementsByTagName("body")[0]) {
                    ...
                    t.style.position = "fixed", t.style.width = "100%", t.style.height = "100%", t.style.zIndex = "9999", t.style.left = "0", t.style.top = "0", t.setAttribute("id", "qLtempOverlay"), document.getElementsByTagName("body")[0].appendChild(t), window.clearInterval(e)
                }
            }, 1)
        }
    }, {}],
        ...
        var i = e("./../ImagePreloader"),
            ...
            o = {
                ...
                createOverlay: function() {
                    this.overlay = r(this.element), this.overlay.idName = this.options.overlayId, this.overlay.percentageId = this.options.percentageId, this.overlay.barHeight = this.options.barHeight, this.overlay.barColor = this.options.barColor, this.overlay.showPercentage = this.options.percentage, this.overlay.fadeOutTime = this.options.fadeOutTime, "undefined" != typeof this.element && this.overlay.init()
                },
